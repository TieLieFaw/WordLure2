 ...
 *
 */
public class soundChooseRandomTesterTest {
	...
	public void testInspect() {
		AbstractLogic logic = new soundChooseRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
	...
	public void testGetName() {
		AbstractLogic logic = new soundChooseRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
		assertEquals("Logic's class returns incorrect name",logic.getName(), "Listen and choose (Random)");
	}
