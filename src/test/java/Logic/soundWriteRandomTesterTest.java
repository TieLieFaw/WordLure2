 ...
 *
 */
public class soundWriteRandomTesterTest {
	...
	public void testInspect() {
		AbstractLogic logic = new soundWriteRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
	...
	public void testGetName() {
		AbstractLogic logic = new soundWriteRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
		assertEquals("Logic's class returns incorrect name", logic.getName(), "Listen and write(Random)");
	}
