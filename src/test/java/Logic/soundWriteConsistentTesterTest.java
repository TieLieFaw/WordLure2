 ...
 *
 */
public class soundWriteConsistentTesterTest {
	...
	public void testInspect() {
		AbstractLogic logic = new soundWriteConsistentTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
	...
	public void testGetName() {
		AbstractLogic logic = new soundWriteConsistentTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
		assertEquals("Logic's class returns incorrect name", logic.getName(), "Listen and write(Consistent)");
	}
