 ...
 *
 */
public class backRandomTesterTest {
	...
	public void testInspect() {
		AbstractLogic logic = new backRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
	...
	public void testGetName() {
		AbstractLogic logic = new backRandomTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
		assertEquals("Logic's class returns incorrect name",logic.getName(), new StringBuilder().append("Random translate from ").append(SECOND_LANGUAGE).append(" into ").append(FIRST_LANGUAGE).toString());
	}
