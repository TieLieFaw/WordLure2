 ...
 *
 */
public class aheadConsistentTesterTest {
	...
	public void testGetName() {
		AbstractLogic logic = new aheadConsistentTester(FIRST_LANGUAGE, SECOND_LANGUAGE);
		assertEquals("Logic's class returns incorrect name",logic.getName(), new StringBuilder().append("Translate from ").append(FIRST_LANGUAGE).append(" into ").append(SECOND_LANGUAGE).toString());
	}
